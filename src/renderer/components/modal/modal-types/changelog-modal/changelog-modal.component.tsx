...
export const ChangelogModal: ModalComponent<void, ChangelogData> = ({ resolver, data }) => {
  ...
  return (
    <form className="w-[350px] text-gray-800 dark:text-gray-200 h-[70vh] flex flex-col">
      ...
      <div className="relative h-80 ">
        <div className=" absolute overflow-y-scroll h-full content grow" dangerouslySetInnerHTML={{ __html: data?.body }}/>
      </div>
