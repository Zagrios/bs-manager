...
export const UninstallModModal: ModalComponent<void, string> = ({ resolver, options: { data } }) => {
    const modName = data;
    const t = useTranslation();

    const desc = modName.toLowerCase() === "bsipa" ? "modals.uninstall-mod.description-bsipa" : "modals.uninstall-mod.description";
    ...
    return (
        ...
        >
            ...
            <p className="max-w-sm text-gray-800 dark:text-gray-200">{t(desc, { mod: modName })}</p>
