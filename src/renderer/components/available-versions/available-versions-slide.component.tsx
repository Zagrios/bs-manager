...
export function AvailableVersionsSlide(props: {year: string}) {
  ...
  return (
    <div className="w-full max-w-full max-h-full shrink-0 flex items-start justify-center overflow-x-hidden overflow-y-scroll content-start scrollbar-thin scrollbar-thumb-neutral-900">
